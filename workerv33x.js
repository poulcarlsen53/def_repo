...
// workerv33x - upstream proxy fix: removed per-IP WebSocket connection limit (v32 had 20/IP cap)
// Debug mode flag
...
const OVERALL_CONNECTION_TIMEOUT = 120000;
...
var worker_default = {
  async fetch(request, env, context) {
    ...
    // v33x: No per-IP connection limit for WebSocket - restores upstream proxy compatibility
